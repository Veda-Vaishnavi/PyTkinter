...
#https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=3BCFCE82-F4EC-4E41-B8C4-299B2C1C2AFD
...
def ziplookup():
    ...
    try:
        api_request=requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+zip.get()+"&distance=5&API_KEY=3BCFCE82-F4EC-4E41-B8C4-299B2C1C2AFD")
